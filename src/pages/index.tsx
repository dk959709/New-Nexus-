...
export function HomePage() {
  ...
  return <>
    <section className="hero"><span className="eyebrow">NEXUS NEXUS INTELLIGENCE</span><h1>Search the web.<br /><span>Understand the world.</span></h1><p>One clear signal from billions of data points. Search, weather, and live context in one calm interface.</p></section>
