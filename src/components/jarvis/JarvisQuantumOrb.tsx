      ...
      >
        ...
        >
          <defs>
            ...
            <radialGradient id="jarvis3dBallGrad" cx="35%" cy="30%" r="70%">
            ...
            <linearGradient id="jarvisRingGradCyanPurple" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#61d7c9" />
              <stop offset="50%" stopColor="#38bdf8" />
              <stop offset="100%" stopColor="#c084fc" />
            </linearGradient>

            <linearGradient id="jarvisRingGradGoldRose" x1="100%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#fb7185" />
              <stop offset="50%" stopColor="#f59e0b" />
              <stop offset="100%" stopColor="#34d399" />
            </linearGradient>

            <linearGradient id="jarvisRingGradNeon" x1="0%" y1="50%" x2="100%" y2="50%">
            ...
            {/* Glowing Drop Filter */}
            <filter id="ballGlowFilter" x="-50%" y="-50%" width="200%" height="200%">
              <feGaussianBlur in="SourceGraphic" stdDeviation={isRunning ? 6 : 4} result="blur" />
          ...
          >
            <ellipse
              ...
              ry={radius * 0.35}
              fill="none"
              stroke="url(#jarvisRingGradCyanPurple)"
              strokeWidth={isRunning ? 2.5 : 1.8}
              strokeDasharray="60 12 24 8"
          ...
          >
            <ellipse
              ...
              ry={radius * 0.32}
              fill="none"
              stroke="url(#jarvisRingGradGoldRose)"
              strokeWidth={isRunning ? 2.2 : 1.6}
